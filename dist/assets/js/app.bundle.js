...
exports.homevideo = exports.$homevideo = exports.$loadscreen = exports.$top = undefined;

var _globals = __webpack_require__(0);

var $top = exports.$top = $('#top'),
    $loadscreen = exports.$loadscreen = $('#dhr-loadscreen'),
    $homevideo = exports.$homevideo = $('#dhr-home-videoel'),
    homevideo = exports.homevideo = $homevideo[0];
...
var DesignerOptions = function () {
	function DesignerOptions(options) {
		_classCallCheck(this, DesignerOptions);
	...
	_createClass(DesignerOptions, [{
		key: 'buildUI',
		value: function buildUI() {
			var html = '<div id="dopts-panel" class="dopts--panel"><div class="dopts--inner">';
			html += '<div class="dopts--close"><button id="dopts-toggle">Close</button></div>';
			html += '<ul>';
			for (var prop in this.opts) {
				var checked = $body.hasClass('version-' + prop) ? 'checked' : '';
		...
		key: 'togglePluginProp',
		value: function togglePluginProp(prop) {
		...
		value: function bindUIActions() {
			...
			var $toggle = this.$panel.find('#dopts-toggle'),
			...
			$chkbx.each(function () {
				...
				$t.change(function () {
					return $body.toggleClass('version-' + $t.attr('name'));
				});
			});

			$toggle.click(function () {
				return _this.$panel.toggleClass('dopts--opened');
			});
		}
	}]);
...
exports.default = DesignerOptions;
...
var _breakpoints = __webpack_require__(2);

var _breakpoints2 = _interopRequireDefault(_breakpoints);

var _designerOptions = __webpack_require__(5);

var _designerOptions2 = _interopRequireDefault(_designerOptions);
...
var $spltels = $('.dhr-preheadline, .dhr-sectionheadline, .dhr-mainheadline'),
    ...
    spltlines = splttxt.lines; //plugins.min.js is loaded before the webpack bundle
