...
var $mainnav = (0, _jquery2.default)('#dhr-mainnav'),
    $navtoggle = (0, _jquery2.default)('#dhr-menu-toggle');
...
var scrollUpdate = function scrollUpdate() {
	...
	winheight = $window.height();
	scrollCurrent = (0, _jquery2.default)(window).scrollTop();
...
// Contact Modal
var $modaltrigger = (0, _jquery2.default)('a[href="#contact"]'),
    $modalclose = (0, _jquery2.default)('#dhr-modalclose'),
    $modal = (0, _jquery2.default)('#dhr-contactmodal');
